...
function fakeEnv(): AppEnv {
  return {
    ...
    AI_PRIMARY_INPUT_USD_PER_M: 0.0798,
    AI_PRIMARY_OUTPUT_USD_PER_M: 0.1596,
    AI_FALLBACK_INPUT_USD_PER_M: 0.1,
    AI_FALLBACK_OUTPUT_USD_PER_M: 0.6,
...
describe('model router', () => {
  it('uses Luna after the DeepSeek attempt fails and audits both attempts', async () => {
    ...
    const audit: AiAuditRepository = {
      ...
      recordProviderRequest: () => undefined,
