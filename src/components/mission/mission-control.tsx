...
export function MissionControl({ initialDashboard }: { initialDashboard: MissionDashboardDto }) {
  return (
    <MissionStoreProvider initial={initialDashboard}>
      <MissionControlInner />
...
function MissionControlInner() {
  ...
  return (
    <main className={`mission-app mission-app--${mode} mission-app--${theme}`}>
      <MissionToolbar />
      {mode === 'simple' ? (
        <div className="mission-grid mission-grid--simple">
          <OrderList />
