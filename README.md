...
- аудит моделей, токенов, стоимости, задержки, ошибок и tool calls.
...
- desktop-first интерфейс 1440×900 с адаптацией до 1024 px.
...
npm run screenshots    PASS — 4 интерфейсных экрана
...
- цены и доступность моделей нужно проверить перед сдачей;
